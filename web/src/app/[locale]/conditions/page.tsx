    ...
    <article className="prose prose-slate mx-auto max-w-3xl py-4">
      ...
      {fr ? (
        <>
          ...
          <p>
            Aqlee Invest fournit des informations financières, des données de
          ...
          <p>
            ...
            sollicitation. Aqlee Invest n&apos;est pas une société de gestion et
        ...
        <>
          ...
          <p>
            Aqlee Invest provides financial information, market data and
          ...
          <p>
            ...
            recommendation to buy or sell nor a solicitation. Aqlee Invest is
